...
class Flat: Construction {
    ...
    override funcprice(_ width: Double, _ height: Double) {
...
class Area {
    ...
    static funccircleArea(radius: Double) {
        print(3.14 *radius * radius)
    }
    
    class funcsquareArea(side: Double) {
        print(side *side)
    }
...
class ShapeArea: Area {
    ...
    override classfunc squareArea(side: Double) {
    print(side *side)
    }
